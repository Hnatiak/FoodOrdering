    ...
    <FooterContainer>
      <Container>
        <Menu>
          ...
          <ul>
            <LinkLi><NavLink to="/">Про нас</NavLink></LinkLi>
            <LinkLi><NavLink to="/">Наші послуги</NavLink></LinkLi>
            <LinkLi><NavLink to="/">Контакти</NavLink></LinkLi>
            <LinkLi><NavLink to="/">Каталог піц</NavLink></LinkLi>
          </ul>
        </Menu>
        <Menu>
        ...
        <Menu>
          <Title>Про нас</Title>
          <p style={{ color: '#bbb' }}>Опис компанії</p>
        </Menu>
        <Contacts>
          <Title>Зв'яжіться з нами</Title>
          <ul>
            <ContactsLi><a href="tel:+380504301696">+38 (050) 430-16-96</a>
            </ContactsLi>
            <ContactsLi><a href="tel:+380673231734">+38 (067) 323-17-34</a>
            </ContactsLi>
            <ContactsLi><a href="tel:+380673231736">+38 (067) 323-17-36</a>
            </ContactsLi>
            <ContactsLi><a href="mailto:test@gmail.com">test@gmail.com</a>
            </ContactsLi>
          </ul>
        </Contacts>
      </Container>
